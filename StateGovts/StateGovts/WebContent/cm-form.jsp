...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4">
				<form action="${pageContext.request.contextPath}/EmployeeController"
					...
					<div class = "form-group">
						<input type = "text" class = "form-control" name = "party" placeholder = "Enter Party" value = "${employee.party}"/>
					</div>
		...
		<a
			href="${pageContext.request.contextPath}/EmployeeController?action=LIST">Back
			to List</a>
	</div>
